# Post'IT - Next.js & React

This is a [Next.js](https://nextjs.org) project bootstrapped with [`create-next-app && npm audit fix --force`](https://nextjs.org/docs/app/api-reference/cli/create-next-app).
